  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new About" do
        expect {
          post :create, params: {about: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved about as @about" do
        post :create, params: {about: invalid_attributes}, session: valid_session
        expect(assigns(:about)).to be_a_new(About)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested about" do
        about = About.create! valid_attributes
        put :update, params: {id: about.to_param, about: new_attributes}, session: valid_session
        about.reload
      ...
      it "assigns the requested about as @about" do
        about = About.create! valid_attributes
        put :update, params: {id: about.to_param, about: valid_attributes}, session: valid_session
        expect(assigns(:about)).to eq(about)
      end
    ...
    context "with invalid params" do
      it "assigns the about as @about" do
        about = About.create! valid_attributes
        put :update, params: {id: about.to_param, about: invalid_attributes}, session: valid_session
        expect(assigns(:about)).to eq(about)
      end
